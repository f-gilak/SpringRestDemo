package com.fariba.springrestdemo.config;
...
//                .withUser(users.username("mary").password("fun123").roles("EMPLOYEE", "MANAGER"))
//                .withUser(users.username("susan").password("fun123").roles("EMPLOYEE", "ADMIN"));
    }
